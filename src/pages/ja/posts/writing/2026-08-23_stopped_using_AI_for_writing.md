...
category: writing 
---
*Read the English version [here](/posts/writing/2026-08-05_stopped_using_AI_for_writing/).*

母国語が英語ではなく、ライティングの講義をそんなにとっていないこともあって、英文を書くスキルにそんなに自信があるわけではない。  
だからこのサイトでブログを書き始めたときは、Grammarly とか ChatGPT を使って文法ミスとか不自然な表現を直していたのだが、あるとき <a class="icon-new-tab" target="_blank" href="https://enocc.com/">Pablo Enoc</a> という人のこの記事を読んで、AIや翻訳サービスとの向き合い方がちょっと変わった。  
- It's Insulting to Read Your AI Writing [^1]
...
これらのサービスを使うのをやめてからの感想は、  
「記事を出すまでの工程が減ってめっちゃラク！」

別にこれから間違いをそのままにしておくというわけではなくて、ちょこちょこ修正したり編集したりしていこうとは思っている。
